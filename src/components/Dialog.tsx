...
const DialogFooter = ({
  ...
  <div
    className={cn(
      "flex flex-col space-y-4 sm:flex-row sm:space-x-4",
      className
    )}
    {...props}
  />
